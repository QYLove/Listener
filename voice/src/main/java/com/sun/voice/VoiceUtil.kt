...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "班", "般" -> mp = MediaPlayer.create(context, R.raw.ban1)
            ...
            "饱", "宝", "保" -> mp = MediaPlayer.create(context, R.raw.bao3)
            ...
            "贝", "备", "背", "倍", "被" -> mp = MediaPlayer.create(context, R.raw.bei4)
            ...
            "变", "便" -> mp = MediaPlayer.create(context, R.raw.bian4)
            ...
            "拨", "波", "玻" -> mp = MediaPlayer.create(context, R.raw.bo1)
            ...
            "残", "蚕" -> mp = MediaPlayer.create(context, R.raw.can2)
            ...
            "册", "厕", "侧", "测" -> mp = MediaPlayer.create(context, R.raw.ce4)
            "层" -> mp = MediaPlayer.create(context, R.raw.ceng2)
            "叉", "差" -> mp = MediaPlayer.create(context, R.raw.cha1)
            ...
            "长", "肠", "尝" -> mp = MediaPlayer.create(context, R.raw.chang2)
            "厂", "场" -> mp = MediaPlayer.create(context, R.raw.chang3)
            "畅", "倡" -> mp = MediaPlayer.create(context, R.raw.chang4)
            "抄", "钞" -> mp = MediaPlayer.create(context, R.raw.chao1)
            ...
            "成", "呈", "诚", "承", "城", "乘" -> mp = MediaPlayer.create(context, R.raw.cheng2)
            "秤" -> mp = MediaPlayer.create(context, R.raw.cheng4)
            "吃" -> mp = MediaPlayer.create(context, R.raw.chi1)
            "池", "驰", "迟", "持" -> mp = MediaPlayer.create(context, R.raw.chi2)
            ...
            "除" -> mp = MediaPlayer.create(context, R.raw.chu2)
            "础" -> mp = MediaPlayer.create(context, R.raw.chu3)
            ...
            "疮" -> mp = MediaPlayer.create(context, R.raw.chuang1)
            ...
            "代", "带", "贷", "待", "怠" -> mp = MediaPlayer.create(context, R.raw.dai4)
            ...
            "敌" -> mp = MediaPlayer.create(context, R.raw.di2)
            "抵", "底" -> mp = MediaPlayer.create(context, R.raw.di3)
            "地", "弟", "帝", "递" -> mp = MediaPlayer.create(context, R.raw.di4)
            ...
            "吊", "钓", "调" -> mp = MediaPlayer.create(context, R.raw.diao4)
            "爹" -> mp = MediaPlayer.create(context, R.raw.die1)
            ...
            "杜", "肚", "度" -> mp = MediaPlayer.create(context, R.raw.du4)
            "段" -> mp = MediaPlayer.create(context, R.raw.duan4)
            ...
            "丰", "风", "封", "疯", "峰" -> mp = MediaPlayer.create(context, R.raw.feng1)
            ...
            "伏", "扶", "服", "俘", "浮" -> mp = MediaPlayer.create(context, R.raw.fu2)
            "抚", "斧", "府", "俯" -> mp = MediaPlayer.create(context, R.raw.fu3)
            "父", "付", "负", "妇", "附", "咐", "赴", "复" -> mp = MediaPlayer.create(context, R.raw.fu4)
            //g
            ...
            "杆", "秆", "赶" -> mp = MediaPlayer.create(context, R.raw.gan3)
            ...
            "哥", "胳" -> mp = MediaPlayer.create(context, R.raw.ge1)
            "革", "阁", "格" -> mp = MediaPlayer.create(context, R.raw.ge2)
            ...
            "禾", "合", "何", "和", "河", "荷", "核" -> mp = MediaPlayer.create(context, R.raw.he2)
            ...
            "狐", "胡", "壶" -> mp = MediaPlayer.create(context, R.raw.hu2)
            "虎" -> mp = MediaPlayer.create(context, R.raw.hu3)
            "互", "户" -> mp = MediaPlayer.create(context, R.raw.hu4)
            "划", "华", "哗" -> mp = MediaPlayer.create(context, R.raw.hua2)
            ...
            "幻", "换", "唤" -> mp = MediaPlayer.create(context, R.raw.huan4)
            "荒" -> mp = MediaPlayer.create(context, R.raw.huang1)
            "皇" -> mp = MediaPlayer.create(context, R.raw.huang2)
            "晃" -> mp = MediaPlayer.create(context, R.raw.huang4)
            "灰", "挥", "恢" -> mp = MediaPlayer.create(context, R.raw.hui1)
            "回" -> mp = MediaPlayer.create(context, R.raw.hui2)
            "悔" -> mp = MediaPlayer.create(context, R.raw.hui3)
            "汇", "会", "绘", "贿" -> mp = MediaPlayer.create(context, R.raw.hui4)
            ...
            "或", "货", "获" -> mp = MediaPlayer.create(context, R.raw.huo4)
            //i
            //j
            "击", "饥", "圾", "机", "肌", "鸡", "积" -> mp = MediaPlayer.create(context, R.raw.ji1)
            "及", "吉", "级", "极", "即", "急", "疾" -> mp = MediaPlayer.create(context, R.raw.ji2)
            "几", "己", "挤", "脊" -> mp = MediaPlayer.create(context, R.raw.ji3)
            "计", "记", "纪", "技", "忌", "际", "季", "剂", "迹", "济", "既", "继" -> mp =
            ...
            "拣", "茧", "俭", "捡" -> mp = MediaPlayer.create(context, R.raw.jian3)
            "见", "件", "建", "荐", "贱", "剑", "健", "舰" -> mp = MediaPlayer.create(context, R.raw.jian4)
            ...
            "交", "郊", "浇", "娇", "骄", "胶" -> mp = MediaPlayer.create(context, R.raw.jiao1)
            "角", "狡", "饺", "绞" -> mp = MediaPlayer.create(context, R.raw.jiao3)
            "叫", "轿", "较" -> mp = MediaPlayer.create(context, R.raw.jiao4)
            "阶", "皆" -> mp = MediaPlayer.create(context, R.raw.jie1)
            "节", "杰", "洁", "结" -> mp = MediaPlayer.create(context, R.raw.jie2)
            "姐" -> mp = MediaPlayer.create(context, R.raw.jie3)
            "介", "戒", "届", "界", "借" -> mp = MediaPlayer.create(context, R.raw.jie4)
            "巾", "斤", "今", "金", "津" -> mp = MediaPlayer.create(context, R.raw.jin1)
            ...
            "径", "净", "竞" -> mp = MediaPlayer.create(context, R.raw.jing4)
            ...
            "巨", "句", "拒", "具", "矩", "俱", "剧" -> mp = MediaPlayer.create(context, R.raw.ju4)
            ...
            "决", "觉", "绝" -> mp = MediaPlayer.create(context, R.raw.jue2)
            ...
            "科" -> mp = MediaPlayer.create(context, R.raw.ke1)
            ...
            "扩", "括" -> mp = MediaPlayer.create(context, R.raw.kuo4)
            //l
            ...
            "郎", "狼" -> mp = MediaPlayer.create(context, R.raw.lang2)
            ...
            "泪", "类" -> mp = MediaPlayer.create(context, R.raw.lei4)
            "冷" -> mp = MediaPlayer.create(context, R.raw.leng3)
            "厘", "狸", "离" -> mp = MediaPlayer.create(context, R.raw.li2)
            "礼", "李", "里" -> mp = MediaPlayer.create(context, R.raw.li3)
            "力", "历", "厉", "立", "丽", "励", "利", "例", "隶", "栗" -> mp =
                MediaPlayer.create(context, R.raw.li4)
            "俩" -> mp = MediaPlayer.create(context, R.raw.lia3)
            "连", "怜", "帘", "莲" -> mp = MediaPlayer.create(context, R.raw.lian2)
            "练", "炼", "恋" -> mp = MediaPlayer.create(context, R.raw.lian4)
            "良", "凉" -> mp = MediaPlayer.create(context, R.raw.liang2)
            "两" -> mp = MediaPlayer.create(context, R.raw.liang3)
            "亮", "谅" -> mp = MediaPlayer.create(context, R.raw.liang4)
            "辽", "疗" -> mp = MediaPlayer.create(context, R.raw.liao2)
            "料" -> mp = MediaPlayer.create(context, R.raw.liao4)
            "列", "劣", "烈" -> mp = MediaPlayer.create(context, R.raw.lie4)
            "邻", "林", "临" -> mp = MediaPlayer.create(context, R.raw.lin2)
            ...
            "络", "骆" -> mp = MediaPlayer.create(context, R.raw.luo4)
            "驴" -> mp = MediaPlayer.create(context, R.raw.lv2)
            "旅" -> mp = MediaPlayer.create(context, R.raw.lv3)
            "律", "虑" -> mp = MediaPlayer.create(context, R.raw.lv4)
            //m
            ...
            "茂", "冒", "贸" -> mp = MediaPlayer.create(context, R.raw.mao4)
            "么" -> mp = MediaPlayer.create(context, R.raw.me0)
            "没", "眉" -> mp = MediaPlayer.create(context, R.raw.mei2)
            ...
            "迷" -> mp = MediaPlayer.create(context, R.raw.mi2)
            "米" -> mp = MediaPlayer.create(context, R.raw.mi3)
            "秘" -> mp = MediaPlayer.create(context, R.raw.mi4)
            "眠" -> mp = MediaPlayer.create(context, R.raw.mian2)
            ...
            "陪" -> mp = MediaPlayer.create(context, R.raw.pei2)
            ...
            "皮", "疲" -> mp = MediaPlayer.create(context, R.raw.pi2)
            ...
            "平", "评", "苹", "凭", "瓶" -> mp = MediaPlayer.create(context, R.raw.ping2)
            ...
            "千", "迁", "牵", "铅" -> mp = MediaPlayer.create(context, R.raw.qian1)
            ...
            "青", "轻", "倾" -> mp = MediaPlayer.create(context, R.raw.qing1)
            ...
            "柔" -> mp = MediaPlayer.create(context, R.raw.rou2)
            ...
            "扇" -> mp = MediaPlayer.create(context, R.raw.shan4)
            "伤" -> mp = MediaPlayer.create(context, R.raw.shang1)
            "晌" -> mp = MediaPlayer.create(context, R.raw.shang3)
            "上", "尚" -> mp = MediaPlayer.create(context, R.raw.shang4)
            "捎", "烧" -> mp = MediaPlayer.create(context, R.raw.shao1)
            ...
            "书", "叔", "殊" -> mp = MediaPlayer.create(context, R.raw.shu1)
            ...
            "司", "丝", "私", "思" -> mp = MediaPlayer.create(context, R.raw.si1)
            ...
            "诉", "肃", "素", "速" -> mp = MediaPlayer.create(context, R.raw.su4)
            ...
            "所", "索" -> mp = MediaPlayer.create(context, R.raw.suo3)
            //t
            ...
            "叹", "炭" -> mp = MediaPlayer.create(context, R.raw.tan4)
            "汤" -> mp = MediaPlayer.create(context, R.raw.tang1)
            "唐" -> mp = MediaPlayer.create(context, R.raw.tang2)
            "倘" -> mp = MediaPlayer.create(context, R.raw.tang3)
            "烫" -> mp = MediaPlayer.create(context, R.raw.tang4)
            "涛" -> mp = MediaPlayer.create(context, R.raw.tao1)
            "逃", "桃", "陶" -> mp = MediaPlayer.create(context, R.raw.tao2)
            ...
            "剃" -> mp = MediaPlayer.create(context, R.raw.ti4)
            ...
            "亭", "庭" -> mp = MediaPlayer.create(context, R.raw.ting2)
            "挺" -> mp = MediaPlayer.create(context, R.raw.ting3)
            "通" -> mp = MediaPlayer.create(context, R.raw.tong1)
            "同", "桐" -> mp = MediaPlayer.create(context, R.raw.tong2)
            "统" -> mp = MediaPlayer.create(context, R.raw.tong3)
            ...
            "图", "徒", "途", "涂" -> mp = MediaPlayer.create(context, R.raw.tu2)
            ...
            //v
            //w
            "挖" -> mp = MediaPlayer.create(context, R.raw.wa1)
            ...
            "弯" -> mp = MediaPlayer.create(context, R.raw.wan1)
            "丸", "完", "玩", "顽" -> mp = MediaPlayer.create(context, R.raw.wan2)
            "挽" -> mp = MediaPlayer.create(context, R.raw.wan3)
            ...
            "卫", "未", "位", "味", "畏", "胃" -> mp = MediaPlayer.create(context, R.raw.wei4)
            ...
            //x
            "夕", "西", "吸", "希", "析", "牺", "息" -> mp = MediaPlayer.create(context, R.raw.xi1)
            "习", "席" -> mp = MediaPlayer.create(context, R.raw.xi2)
            "洗" -> mp = MediaPlayer.create(context, R.raw.xi3)
            ...
            "闲", "贤", "弦", "咸" -> mp = MediaPlayer.create(context, R.raw.xian2)
            "显", "险" -> mp = MediaPlayer.create(context, R.raw.xian3)
            "县", "现", "限", "线", "宪", "陷" -> mp = MediaPlayer.create(context, R.raw.xian4)
            ...
            "向", "项", "巷" -> mp = MediaPlayer.create(context, R.raw.xiang4)
            "消", "宵" -> mp = MediaPlayer.create(context, R.raw.xiao1)
            ...
            "泄", "泻", "卸", "屑" -> mp = MediaPlayer.create(context, R.raw.xie4)
            ...
            "秀", "袖", "绣" -> mp = MediaPlayer.create(context, R.raw.xiu4)
            "须" -> mp = MediaPlayer.create(context, R.raw.xu1)
            "徐" -> mp = MediaPlayer.create(context, R.raw.xu2)
            "许" -> mp = MediaPlayer.create(context, R.raw.xu3)
            "序", "叙" -> mp = MediaPlayer.create(context, R.raw.xu4)
            ...
            "仪", "宜", "姨" -> mp = MediaPlayer.create(context, R.raw.yi2)
            "乙", "已", "以", "蚁", "倚" -> mp = MediaPlayer.create(context, R.raw.yi3)
            ...
            "迎", "盈" -> mp = MediaPlayer.create(context, R.raw.ying2)
            "应", "映" -> mp = MediaPlayer.create(context, R.raw.ying4)
            ...
            "于", "余", "鱼", "娱" -> mp = MediaPlayer.create(context, R.raw.yu2)
            "与", "予", "屿", "宇", "羽", "雨", "语" -> mp = MediaPlayer.create(context, R.raw.yu3)
            "玉", "育", "狱", "浴", "预" -> mp = MediaPlayer.create(context, R.raw.yu4)
            "冤" -> mp = MediaPlayer.create(context, R.raw.yuan1)
            "元", "园", "员", "原", "圆" -> mp = MediaPlayer.create(context, R.raw.yuan2)
            ...
            "月", "阅", "悦" -> mp = MediaPlayer.create(context, R.raw.yue4)
            ...
            "斩", "盏", "展" -> mp = MediaPlayer.create(context, R.raw.zhan3)
            "占", "战", "站" -> mp = MediaPlayer.create(context, R.raw.zhan4)
            "张" -> mp = MediaPlayer.create(context, R.raw.zhang1)
            "涨" -> mp = MediaPlayer.create(context, R.raw.zhang3)
            ...
            "执", "直", "侄", "值" -> mp = MediaPlayer.create(context, R.raw.zhi2)
            "止", "旨", "址", "纸", "指" -> mp = MediaPlayer.create(context, R.raw.zhi3)
            "至", "帜", "制", "质", "治", "致", "秩" -> mp = MediaPlayer.create(context, R.raw.zhi4)
            ...
            "舟", "州", "周", "洲" -> mp = MediaPlayer.create(context, R.raw.zhou1)
            "宙", "昼", "皱" -> mp = MediaPlayer.create(context, R.raw.zhou4)
            "朱", "珠", "株", "诸" -> mp = MediaPlayer.create(context, R.raw.zhu1)
            "竹", "逐", "烛" -> mp = MediaPlayer.create(context, R.raw.zhu2)
            "主" -> mp = MediaPlayer.create(context, R.raw.zhu3)
            "助", "住", "注", "驻", "柱", "祝" -> mp = MediaPlayer.create(context, R.raw.zhu4)
            ...
            "浊" -> mp = MediaPlayer.create(context, R.raw.zhuo2)
            "姿", "资" -> mp = MediaPlayer.create(context, R.raw.zi1)
            ...
            "作", "坐", "座" -> mp = MediaPlayer.create(context, R.raw.zuo4)
