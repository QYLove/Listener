...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "百" -> mp = MediaPlayer.create(context, R.raw.bai3)
            "办", "半" -> mp = MediaPlayer.create(context, R.raw.ban4)
            ...
            "冰" -> mp = MediaPlayer.create(context, R.raw.bing1)
            ...
            "臣", "尘" -> mp = MediaPlayer.create(context, R.raw.chen2)
            "成" -> mp = MediaPlayer.create(context, R.raw.cheng2)
            "吃" -> mp = MediaPlayer.create(context, R.raw.chi1)
            "池", "驰" -> mp = MediaPlayer.create(context, R.raw.chi2)
            "尺" -> mp = MediaPlayer.create(context, R.raw.chi3)
            "斥" -> mp = MediaPlayer.create(context, R.raw.chi4)
            ...
            "出" -> mp = MediaPlayer.create(context, R.raw.chu1)
            ...
            "次" -> mp = MediaPlayer.create(context, R.raw.ci4)
            ...
            "旦" -> mp = MediaPlayer.create(context, R.raw.dan4)
            "当" -> mp = MediaPlayer.create(context, R.raw.dang1)
            "刀", "叨" -> mp = MediaPlayer.create(context, R.raw.dao1)
            "导" -> mp = MediaPlayer.create(context, R.raw.dao3)
            "的" -> mp = MediaPlayer.create(context, R.raw.de0)
            "灯" -> mp = MediaPlayer.create(context, R.raw.deng1)
            "地" -> mp = MediaPlayer.create(context, R.raw.di4)
            "电" -> mp = MediaPlayer.create(context, R.raw.dian4)
            "叼" -> mp = MediaPlayer.create(context, R.raw.diao1)
            "吊" -> mp = MediaPlayer.create(context, R.raw.diao4)
            "丁", "叮" -> mp = MediaPlayer.create(context, R.raw.ding1)
            ...
            "动" -> mp = MediaPlayer.create(context, R.raw.dong4)
            ...
            "犯" -> mp = MediaPlayer.create(context, R.raw.fan4)
            "方" -> mp = MediaPlayer.create(context, R.raw.fang1)
            "防" -> mp = MediaPlayer.create(context, R.raw.fang2)
            "仿", "访" -> mp = MediaPlayer.create(context, R.raw.fang3)
            "飞" -> mp = MediaPlayer.create(context, R.raw.fei1)
            "分" -> mp = MediaPlayer.create(context, R.raw.fen1)
            "份" -> mp = MediaPlayer.create(context, R.raw.fen4)
            ...
            "伏" -> mp = MediaPlayer.create(context, R.raw.fu2)
            "父", "付", "负", "妇" -> mp = MediaPlayer.create(context, R.raw.fu4)
            //g
            "甘" -> mp = MediaPlayer.create(context, R.raw.gan1)
            "干" -> mp = MediaPlayer.create(context, R.raw.gan4)
            "冈", "刚" -> mp = MediaPlayer.create(context, R.raw.gang1)
            ...
            "共" -> mp = MediaPlayer.create(context, R.raw.gong4)
            "勾" -> mp = MediaPlayer.create(context, R.raw.gou1)
            "古" -> mp = MediaPlayer.create(context, R.raw.gu3)
            "瓜" -> mp = MediaPlayer.create(context, R.raw.gua1)
            "关", "观" -> mp = MediaPlayer.create(context, R.raw.guan1)
            "光" -> mp = MediaPlayer.create(context, R.raw.guang1)
            "广" -> mp = MediaPlayer.create(context, R.raw.guang3)
            "归" -> mp = MediaPlayer.create(context, R.raw.gui1)
            ...
            //h
            "汉", "汗" -> mp = MediaPlayer.create(context, R.raw.han4)
            "号" -> mp = MediaPlayer.create(context, R.raw.hao2)
            "好" -> mp = MediaPlayer.create(context, R.raw.hao3)
            "禾", "合" -> mp = MediaPlayer.create(context, R.raw.he2)
            "红" -> mp = MediaPlayer.create(context, R.raw.hong2)
            "后" -> mp = MediaPlayer.create(context, R.raw.hou4)
            "乎" -> mp = MediaPlayer.create(context, R.raw.hu1)
            ...
            //i
            //j
            "击", "饥", "圾", "机", "肌" -> mp = MediaPlayer.create(context, R.raw.ji1)
            "及", "吉", "级" -> mp = MediaPlayer.create(context, R.raw.ji2)
            "几", "己" -> mp = MediaPlayer.create(context, R.raw.ji3)
            "计", "记", "纪" -> mp = MediaPlayer.create(context, R.raw.ji4)
            "加", "夹" -> mp = MediaPlayer.create(context, R.raw.jia1)
            "甲" -> mp = MediaPlayer.create(context, R.raw.jia3)
            "价" -> mp = MediaPlayer.create(context, R.raw.jia4)
            "尖", "奸" -> mp = MediaPlayer.create(context, R.raw.jian1)
            "见", "件" -> mp = MediaPlayer.create(context, R.raw.jian4)
            "江" -> mp = MediaPlayer.create(context, R.raw.jiang1)
            "讲" -> mp = MediaPlayer.create(context, R.raw.jiang3)
            "匠" -> mp = MediaPlayer.create(context, R.raw.jiang4)
            "交" -> mp = MediaPlayer.create(context, R.raw.jiao1)
            ...
            //l
            "兰" -> mp = MediaPlayer.create(context, R.raw.lan2)
            ...
            "礼" -> mp = MediaPlayer.create(context, R.raw.li3)
            "力", "历", "厉", "立" -> mp = MediaPlayer.create(context, R.raw.li4)
            "辽" -> mp = MediaPlayer.create(context, R.raw.liao2)
            ...
            "迈" -> mp = MediaPlayer.create(context, R.raw.mai4)
            "芒", "忙" -> mp = MediaPlayer.create(context, R.raw.mang2)
            "毛", "矛" -> mp = MediaPlayer.create(context, R.raw.mao2)
            ...
            "名" -> mp = MediaPlayer.create(context, R.raw.ming2)
            "末" -> mp = MediaPlayer.create(context, R.raw.mo4)
            "母" -> mp = MediaPlayer.create(context, R.raw.mu3)
            "木", "目" -> mp = MediaPlayer.create(context, R.raw.mu4)
            //n
            "那" -> mp = MediaPlayer.create(context, R.raw.na4)
            "乃", "奶" -> mp = MediaPlayer.create(context, R.raw.nai3)
            "内" -> mp = MediaPlayer.create(context, R.raw.nei4)
            "尼" -> mp = MediaPlayer.create(context, R.raw.ni2)
            ...
            "女" -> mp = MediaPlayer.create(context, R.raw.nv3)
            //o
            //p
            ...
            "平" -> mp = MediaPlayer.create(context, R.raw.ping2)
            ...
            "齐" -> mp = MediaPlayer.create(context, R.raw.qi2)
            "乞", "岂", "企" -> mp = MediaPlayer.create(context, R.raw.qi3)
            ...
            "乔" -> mp = MediaPlayer.create(context, R.raw.qiao2)
            ...
            "曲" -> mp = MediaPlayer.create(context, R.raw.qu3)
            ...
            "杀" -> mp = MediaPlayer.create(context, R.raw.sha1)
            "山" -> mp = MediaPlayer.create(context, R.raw.shan1)
            "闪" -> mp = MediaPlayer.create(context, R.raw.shan3)
            ...
            "设" -> mp = MediaPlayer.create(context, R.raw.she4)
            "申" -> mp = MediaPlayer.create(context, R.raw.shen1)
            ...
            "尸", "失", "师" -> mp = MediaPlayer.create(context, R.raw.shi1)
            "十", "石" -> mp = MediaPlayer.create(context, R.raw.shi2)
            "史" -> mp = MediaPlayer.create(context, R.raw.shi3)
            "是", "士", "氏", "示", "世", "市", "式" -> mp = MediaPlayer.create(context, R.raw.shi4)
            ...
            "司", "丝" -> mp = MediaPlayer.create(context, R.raw.si1)
            "死" -> mp = MediaPlayer.create(context, R.raw.si3)
            "四", "寺", "似" -> mp = MediaPlayer.create(context, R.raw.si4)
            ...
            "台" -> mp = MediaPlayer.create(context, R.raw.tai2)
            ...
            "头" -> mp = MediaPlayer.create(context, R.raw.tou2)
            ...
            "托" -> mp = MediaPlayer.create(context, R.raw.tuo1)
            //u
            //v
            //w
            ...
            "网" -> mp = MediaPlayer.create(context, R.raw.wang3)
            "妄" -> mp = MediaPlayer.create(context, R.raw.wang4)
            "危" -> mp = MediaPlayer.create(context, R.raw.wei1)
            "为" -> mp = MediaPlayer.create(context, R.raw.wei2)
            "伟", "伪" -> mp = MediaPlayer.create(context, R.raw.wei3)
            ...
            "乌", "污" -> mp = MediaPlayer.create(context, R.raw.wu1)
            "无" -> mp = MediaPlayer.create(context, R.raw.wu2)
            "五", "午", "伍" -> mp = MediaPlayer.create(context, R.raw.wu3)
            "勿", "务" -> mp = MediaPlayer.create(context, R.raw.wu4)
            //x
            "夕", "西", "吸" -> mp = MediaPlayer.create(context, R.raw.xi1)
            "习" -> mp = MediaPlayer.create(context, R.raw.xi2)
            "戏" -> mp = MediaPlayer.create(context, R.raw.xi4)
            ...
            "协", "邪" -> mp = MediaPlayer.create(context, R.raw.xie2)
            "写" -> mp = MediaPlayer.create(context, R.raw.xie3)
            "心" -> mp = MediaPlayer.create(context, R.raw.xin1)
            "刑", "行" -> mp = MediaPlayer.create(context, R.raw.xing2)
            "兴" -> mp = MediaPlayer.create(context, R.raw.xing4)
            ...
            "业", "叶", "页" -> mp = MediaPlayer.create(context, R.raw.ye4)
            "一", "衣" -> mp = MediaPlayer.create(context, R.raw.yi1)
            "仪" -> mp = MediaPlayer.create(context, R.raw.yi2)
            "乙", "已", "以" -> mp = MediaPlayer.create(context, R.raw.yi3)
            "亿", "义", "艺", "忆", "议", "亦", "异" -> mp = MediaPlayer.create(context, R.raw.yi4)
            ...
            "永" -> mp = MediaPlayer.create(context, R.raw.yong3)
            "用" -> mp = MediaPlayer.create(context, R.raw.yong4)
            "优" -> mp = MediaPlayer.create(context, R.raw.you1)
            "尤", "由" -> mp = MediaPlayer.create(context, R.raw.you2)
            ...
            "与", "予", "屿", "宇", "羽" -> mp = MediaPlayer.create(context, R.raw.yu3)
            ...
            "孕" -> mp = MediaPlayer.create(context, R.raw.yun4)
            //z
            ...
            "早" -> mp = MediaPlayer.create(context, R.raw.zao3)
            "则" -> mp = MediaPlayer.create(context, R.raw.ze2)
            "扎" -> mp = MediaPlayer.create(context, R.raw.zha1)
            "轧" -> mp = MediaPlayer.create(context, R.raw.zha2)
            "宅" -> mp = MediaPlayer.create(context, R.raw.zhai2)
            "占" -> mp = MediaPlayer.create(context, R.raw.zhan4)
            "丈", "仗" -> mp = MediaPlayer.create(context, R.raw.zhang4)
            "召", "兆" -> mp = MediaPlayer.create(context, R.raw.zhao4)
            "贞" -> mp = MediaPlayer.create(context, R.raw.zhen1)
            "阵" -> mp = MediaPlayer.create(context, R.raw.zhen4)
            "争" -> mp = MediaPlayer.create(context, R.raw.zheng1)
            "正" -> mp = MediaPlayer.create(context, R.raw.zheng4)
            "之", "支", "汁", "只", "芝" -> mp = MediaPlayer.create(context, R.raw.zhi1)
            "执" -> mp = MediaPlayer.create(context, R.raw.zhi2)
            "止", "旨" -> mp = MediaPlayer.create(context, R.raw.zhi3)
            "至" -> mp = MediaPlayer.create(context, R.raw.zhi4)
            "中" -> mp = MediaPlayer.create(context, R.raw.zhong1)
            "众" -> mp = MediaPlayer.create(context, R.raw.zhong4)
            "舟", "州" -> mp = MediaPlayer.create(context, R.raw.zhou1)
            ...
            "壮" -> mp = MediaPlayer.create(context, R.raw.zhuang4)
