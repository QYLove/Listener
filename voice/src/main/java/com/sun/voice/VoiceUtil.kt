...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "驳", "泊", "脖" -> mp = MediaPlayer.create(context, R.raw.bo2)
            ...
            "到", "盗", "悼" -> mp = MediaPlayer.create(context, R.raw.dao4)
            ...
            "堵" -> mp = MediaPlayer.create(context, R.raw.du3)
            "杜", "肚", "度" -> mp = MediaPlayer.create(context, R.raw.du4)
            "段", "断" -> mp = MediaPlayer.create(context, R.raw.duan4)
            ...
            "哥", "胳", "鸽" -> mp = MediaPlayer.create(context, R.raw.ge1)
            ...
            "或", "货", "获", "祸" -> mp = MediaPlayer.create(context, R.raw.huo4)
            //i
            //j
            ...
            "角", "狡", "饺", "绞", "脚" -> mp = MediaPlayer.create(context, R.raw.jiao3)
            "叫", "轿", "较", "教" -> mp = MediaPlayer.create(context, R.raw.jiao4)
            "阶", "皆", "接" -> mp = MediaPlayer.create(context, R.raw.jie1)
            ...
            "茎", "京", "经", "惊" -> mp = MediaPlayer.create(context, R.raw.jing1)
            "井", "颈" -> mp = MediaPlayer.create(context, R.raw.jing3)
            "径", "净", "竞", "竟" -> mp = MediaPlayer.create(context, R.raw.jing4)
            "纠", "究" -> mp = MediaPlayer.create(context, R.raw.jiu1)
            "九", "久", "酒" -> mp = MediaPlayer.create(context, R.raw.jiu3)
            "旧", "救" -> mp = MediaPlayer.create(context, R.raw.jiu4)
            ...
            "亮", "谅", "辆" -> mp = MediaPlayer.create(context, R.raw.liang4)
            "辽", "疗" -> mp = MediaPlayer.create(context, R.raw.liao2)
            "料" -> mp = MediaPlayer.create(context, R.raw.liao4)
            "列", "劣", "烈", "猎" -> mp = MediaPlayer.create(context, R.raw.lie4)
            ...
            "眠", "绵" -> mp = MediaPlayer.create(context, R.raw.mian2)
            ...
            "排" -> mp = MediaPlayer.create(context, R.raw.pai2)
            ...
            "陪", "培" -> mp = MediaPlayer.create(context, R.raw.pei2)
            ...
            //q
            "七", "妻", "戚" -> mp = MediaPlayer.create(context, R.raw.qi1)
            "齐", "其", "奇", "骑" -> mp = MediaPlayer.create(context, R.raw.qi2)
            ...
            "情" -> mp = MediaPlayer.create(context, R.raw.qing2)
            ...
            "雀" -> mp = MediaPlayer.create(context, R.raw.que4)
            //r
            ...
            "捎", "烧", "梢" -> mp = MediaPlayer.create(context, R.raw.shao1)
            ...
            "圣", "胜", "盛" -> mp = MediaPlayer.create(context, R.raw.sheng4)
            ...
            "书", "叔", "殊", "梳" -> mp = MediaPlayer.create(context, R.raw.shu1)
            ...
            "剃", "惕" -> mp = MediaPlayer.create(context, R.raw.ti4)
            ...
            "亭", "庭", "停" -> mp = MediaPlayer.create(context, R.raw.ting2)
            "挺" -> mp = MediaPlayer.create(context, R.raw.ting3)
            "通" -> mp = MediaPlayer.create(context, R.raw.tong1)
            "同", "桐", "铜" -> mp = MediaPlayer.create(context, R.raw.tong2)
            "统", "桶" -> mp = MediaPlayer.create(context, R.raw.tong3)
            ...
            "县", "现", "限", "线", "宪", "陷", "馅" -> mp = MediaPlayer.create(context, R.raw.xian4)
            ...
            "泄", "泻", "卸", "屑", "械" -> mp = MediaPlayer.create(context, R.raw.xie4)
            ...
            "序", "叙", "绪", "续" -> mp = MediaPlayer.create(context, R.raw.xu4)
            ...
            "窑" -> mp = MediaPlayer.create(context, R.raw.yao2)
            ...
            "仪", "宜", "姨", "移" -> mp = MediaPlayer.create(context, R.raw.yi2)
            ...
            "于", "余", "鱼", "娱", "渔" -> mp = MediaPlayer.create(context, R.raw.yu2)
            "与", "予", "屿", "宇", "羽", "雨", "语" -> mp = MediaPlayer.create(context, R.raw.yu3)
            "玉", "育", "狱", "浴", "预", "域", "欲" -> mp = MediaPlayer.create(context, R.raw.yu4)
            ...
            "月", "阅", "悦", "跃" -> mp = MediaPlayer.create(context, R.raw.yue4)
            ...
            "朱", "珠", "株", "诸", "猪" -> mp = MediaPlayer.create(context, R.raw.zhu1)
            "竹", "逐", "烛" -> mp = MediaPlayer.create(context, R.raw.zhu2)
            "主" -> mp = MediaPlayer.create(context, R.raw.zhu3)
            "助", "住", "注", "驻", "柱", "祝", "著" -> mp = MediaPlayer.create(context, R.raw.zhu4)
