...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "雹" -> mp = MediaPlayer.create(context, R.raw.bao2)
            "饱", "宝", "保", "堡" -> mp = MediaPlayer.create(context, R.raw.bao3)
            "抱", "暴" -> mp = MediaPlayer.create(context, R.raw.bao4)
            ...
            "币", "必", "毕", "闭", "毙", "碧", "蔽", "弊" -> mp = MediaPlayer.create(context, R.raw.bi4)
            ...
            "高", "膏" -> mp = MediaPlayer.create(context, R.raw.gao1)
            ...
            "恒", "横" -> mp = MediaPlayer.create(context, R.raw.heng2)
            ...
            "江", "姜", "浆", "僵" -> mp = MediaPlayer.create(context, R.raw.jiang1)
            ...
            "径", "净", "竞", "竟", "敬", "静", "境" -> mp = MediaPlayer.create(context, R.raw.jing4)
            ...
            "兰", "拦", "栏", "蓝" -> mp = MediaPlayer.create(context, R.raw.lan2)
            ...
            "连", "怜", "帘", "莲", "联", "廉" -> mp = MediaPlayer.create(context, R.raw.lian2)
            ...
            "陆", "录", "鹿", "碌", "路" -> mp = MediaPlayer.create(context, R.raw.lu4)
            ...
            "罗", "萝", "锣", "箩", "骡" -> mp = MediaPlayer.create(context, R.raw.luo2)
            ...
            "模", "膜", "摩" -> mp = MediaPlayer.create(context, R.raw.mo2)
            "抹" -> mp = MediaPlayer.create(context, R.raw.mo3)
            "末", "沫", "莫", "漠", "墨" -> mp = MediaPlayer.create(context, R.raw.mo4)
            ...
            "朋", "棚", "蓬" -> mp = MediaPlayer.create(context, R.raw.peng2)
            ...
            "荣", "绒", "容", "熔" -> mp = MediaPlayer.create(context, R.raw.rong2)
            ...
            "暑", "属", "鼠" -> mp = MediaPlayer.create(context, R.raw.shu3)
            ...
            "岁", "碎" -> mp = MediaPlayer.create(context, R.raw.sui4)
            ...
            "唐", "堂", "塘", "膛" -> mp = MediaPlayer.create(context, R.raw.tang2)
            ...
            "提", "题" -> mp = MediaPlayer.create(context, R.raw.ti2)
            ...
            "心", "辛", "欣", "新" -> mp = MediaPlayer.create(context, R.raw.xin1)
            ...
            "妖", "腰" -> mp = MediaPlayer.create(context, R.raw.yao1)
            ...
            "亿", "义", "艺", "忆", "议", "亦", "异", "役", "译", "易", "疫", "益", "谊", "意", "毅" -> mp =
            ...
            "英", "樱" -> mp = MediaPlayer.create(context, R.raw.ying1)
            "迎", "盈", "营", "蝇" -> mp = MediaPlayer.create(context, R.raw.ying2)
            ...
            "遭" -> mp = MediaPlayer.create(context, R.raw.zao1)
