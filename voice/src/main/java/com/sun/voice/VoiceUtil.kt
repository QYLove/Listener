...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "哀" -> mp = MediaPlayer.create(context, R.raw.ai1)
            "安" -> mp = MediaPlayer.create(context, R.raw.an1)
            "岸", "按" -> mp = MediaPlayer.create(context, R.raw.an4)
            ...
            "包", "胞" -> mp = MediaPlayer.create(context, R.raw.bao1)
            ...
            "贝", "备", "背" -> mp = MediaPlayer.create(context, R.raw.bei4)
            ...
            "残" -> mp = MediaPlayer.create(context, R.raw.can2)
            ...
            "成", "呈", "诚", "承", "城" -> mp = MediaPlayer.create(context, R.raw.cheng2)
            ...
            "挡" -> mp = MediaPlayer.create(context, R.raw.dang3)
            "荡" -> mp = MediaPlayer.create(context, R.raw.dang4)
            ...
            "地", "弟", "帝" -> mp = MediaPlayer.create(context, R.raw.di4)
            ...
            "毒", "独" -> mp = MediaPlayer.create(context, R.raw.du2)
            ...
            "盾" -> mp = MediaPlayer.create(context, R.raw.dun4)
            ...
            "丰", "风", "封", "疯" -> mp = MediaPlayer.create(context, R.raw.feng1)
            ...
            "伏", "扶", "服", "俘" -> mp = MediaPlayer.create(context, R.raw.fu2)
            ...
            "革", "阁" -> mp = MediaPlayer.create(context, R.raw.ge2)
            ...
            "工", "弓", "公", "功", "攻", "宫" -> mp = MediaPlayer.create(context, R.raw.gong1)
            ...
            "固", "故" -> mp = MediaPlayer.create(context, R.raw.gu4)
            ...
            "柜", "贵" -> mp = MediaPlayer.create(context, R.raw.gui4)
            ...
            "后", "厚" -> mp = MediaPlayer.create(context, R.raw.hou4)
            "乎", "呼", "忽" -> mp = MediaPlayer.create(context, R.raw.hu1)
            "狐", "胡" -> mp = MediaPlayer.create(context, R.raw.hu2)
            ...
            "汇", "会", "绘" -> mp = MediaPlayer.create(context, R.raw.hui4)
            ...
            "及", "吉", "级", "极", "即", "急" -> mp = MediaPlayer.create(context, R.raw.ji2)
            "几", "己", "挤" -> mp = MediaPlayer.create(context, R.raw.ji3)
            "计", "记", "纪", "技", "忌", "际", "季", "剂", "迹", "济", "既" -> mp =
            ...
            "拣", "茧", "俭" -> mp = MediaPlayer.create(context, R.raw.jian3)
            "见", "件", "建", "荐", "贱", "剑" -> mp = MediaPlayer.create(context, R.raw.jian4)
            "江", "姜" -> mp = MediaPlayer.create(context, R.raw.jiang1)
            "讲", "奖" -> mp = MediaPlayer.create(context, R.raw.jiang3)
            "匠", "降", "将" -> mp = MediaPlayer.create(context, R.raw.jiang4)
            "交", "郊", "浇", "娇", "骄" -> mp = MediaPlayer.create(context, R.raw.jiao1)
            ...
            "介", "戒", "届", "界" -> mp = MediaPlayer.create(context, R.raw.jie4)
            ...
            "巨", "句", "拒", "具", "矩" -> mp = MediaPlayer.create(context, R.raw.ju4)
            ...
            "刻", "客" -> mp = MediaPlayer.create(context, R.raw.ke4)
            "肯", "垦" -> mp = MediaPlayer.create(context, R.raw.ken3)
            ...
            "枯" -> mp = MediaPlayer.create(context, R.raw.ku1)
            ...
            "厘" -> mp = MediaPlayer.create(context, R.raw.li2)
            "礼", "李", "里" -> mp = MediaPlayer.create(context, R.raw.li3)
            "力", "历", "厉", "立", "丽", "励", "利", "例", "隶" -> mp =
            ...
            "练", "炼" -> mp = MediaPlayer.create(context, R.raw.lian4)
            "良" -> mp = MediaPlayer.create(context, R.raw.liang2)
            "两" -> mp = MediaPlayer.create(context, R.raw.liang3)
            "亮" -> mp = MediaPlayer.create(context, R.raw.liang4)
            ...
            "律" -> mp = MediaPlayer.create(context, R.raw.lv4)
            //m
            ...
            "男", "南" -> mp = MediaPlayer.create(context, R.raw.nan2)
            "挠" -> mp = MediaPlayer.create(context, R.raw.nao2)
            "恼" -> mp = MediaPlayer.create(context, R.raw.nao3)
            ...
            "千", "迁", "牵" -> mp = MediaPlayer.create(context, R.raw.qian1)
            "前" -> mp = MediaPlayer.create(context, R.raw.qian2)
            ...
            "青", "轻" -> mp = MediaPlayer.create(context, R.raw.qing1)
            ...
            "权", "全", "泉" -> mp = MediaPlayer.create(context, R.raw.quan2)
            ...
            "荣", "绒" -> mp = MediaPlayer.create(context, R.raw.rong2)
            ...
            "是", "士", "氏", "示", "世", "市", "式", "势", "事", "侍", "饰", "试", "视", "柿", "是", "适", "室" -> mp =
            ...
            "宋", "送", "诵" -> mp = MediaPlayer.create(context, R.raw.song4)
            ...
            "逃" -> mp = MediaPlayer.create(context, R.raw.tao2)
            ...
            "文", "纹", "闻" -> mp = MediaPlayer.create(context, R.raw.wen2)
            ...
            "勿", "务", "物", "误" -> mp = MediaPlayer.create(context, R.raw.wu4)
            //x
            ...
            "县", "现", "限", "线", "宪" -> mp = MediaPlayer.create(context, R.raw.xian4)
            ...
            "泄", "泻", "卸" -> mp = MediaPlayer.create(context, R.raw.xie4)
            ...
            "休", "修" -> mp = MediaPlayer.create(context, R.raw.xiu1)
            ...
            //y
            "压", "呀", "押", "鸦" -> mp = MediaPlayer.create(context, R.raw.ya1)
            ...
            "咽" -> mp = MediaPlayer.create(context, R.raw.yan1)
            "延", "言", "岩", "炎", "沿", "研" -> mp = MediaPlayer.create(context, R.raw.yan2)
            "厌" -> mp = MediaPlayer.create(context, R.raw.yan4)
            "央", "殃" -> mp = MediaPlayer.create(context, R.raw.yang1)
            "扬", "羊", "阳", "杨", "洋" -> mp = MediaPlayer.create(context, R.raw.yang2)
            "仰", "养" -> mp = MediaPlayer.create(context, R.raw.yang3)
            ...
            "乙", "已", "以", "蚁" -> mp = MediaPlayer.create(context, R.raw.yi3)
            "亿", "义", "艺", "忆", "议", "亦", "异", "役", "译", "易", "疫" -> mp =
            ...
            "永", "咏", "泳", "勇" -> mp = MediaPlayer.create(context, R.raw.yong3)
            ...
            "玉", "育", "狱" -> mp = MediaPlayer.create(context, R.raw.yu4)
            ...
            "占", "战" -> mp = MediaPlayer.create(context, R.raw.zhan4)
            ...
            "贞", "针", "侦", "珍" -> mp = MediaPlayer.create(context, R.raw.zhen1)
            ...
            "正", "证", "郑", "政", "挣" -> mp = MediaPlayer.create(context, R.raw.zheng4)
            "之", "支", "汁", "只", "芝", "枝", "知", "肢", "织" -> mp =
            ...
            "宙", "昼" -> mp = MediaPlayer.create(context, R.raw.zhou4)
            ...
            "姿" -> mp = MediaPlayer.create(context, R.raw.zi1)
