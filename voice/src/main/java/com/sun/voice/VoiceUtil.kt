...
object VoiceUtil {
    ...
    fun createVoice(context: Context,index: Int,voiceString: String):MediaPlayer{
        var mp: MediaPlayer?
        var voiceChar = voiceString.substring(index - 1, index)
        var bean = getBeanFromChar(context,voiceChar)
        mp = MediaPlayer.create(context,LocalFileUtil.readLocalRawFile(context,bean.pinyin))
        //控制语速
    ...
    fun getBeanFromChar(context: Context,char:String):VoiceBean{
        var data = DataUtil.getData(context)
        var bean = data?.firstOrNull{it.toString() == char}
        if (bean == null){
            VoiceLog.log(char)
            bean = VoiceBean("某","mou3")
        }
        return bean
    }

//    fun voiceWord(context: Context,bean: VoiceBean):MediaPlayer{
//        if (mediaPlayer == null)
//            mediaPlayer = null
//
//        mediaPlayer = MediaPlayer.create(context,LocalFileUtil.readLocalRawFile(context,bean.pinyin))
//
//        val pp = PlaybackParams()
//        pp.speed = 1.5f
...
//            "矮" -> mp = MediaPlayer.create(context, R.raw.ai3)
//            "爱", "碍" -> mp = MediaPlayer.create(context, R.raw.ai4)
//            "安" -> mp = MediaPlayer.create(context, R.raw.an1)
//            "岸", "按", "案", "暗" -> mp = MediaPlayer.create(context, R.raw.an4)
...
//            "坝", "爸", "罢", "霸" -> mp = MediaPlayer.create(context, R.raw.ba4)
//            "白" -> mp = MediaPlayer.create(context, R.raw.bai2)
//            "百", "伯", "柏", "摆" -> mp = MediaPlayer.create(context, R.raw.bai3)
//            "败", "拜" -> mp = MediaPlayer.create(context, R.raw.bai4)
//            "班", "般", "斑", "搬" -> mp = MediaPlayer.create(context, R.raw.ban1)
//            "板", "版" -> mp = MediaPlayer.create(context, R.raw.ban3)
//            "办", "半", "扮", "伴", "拌", "瓣" -> mp = MediaPlayer.create(context, R.raw.ban4)
//            "帮" -> mp = MediaPlayer.create(context, R.raw.bang1)
//            "绑", "榜", "膀" -> mp = MediaPlayer.create(context, R.raw.bang3)
//            "棒", "傍" -> mp = MediaPlayer.create(context, R.raw.bang4)
//            "包", "胞", "剥" -> mp = MediaPlayer.create(context, R.raw.bao1)
//            "雹", "薄" -> mp = MediaPlayer.create(context, R.raw.bao2)
//            "饱", "宝", "保", "堡" -> mp = MediaPlayer.create(context, R.raw.bao3)
//            "抱", "暴", "爆" -> mp = MediaPlayer.create(context, R.raw.bao4)
//            "杯", "悲", "碑" -> mp = MediaPlayer.create(context, R.raw.bei1)
...
//            "蹦" -> mp = MediaPlayer.create(context, R.raw.beng4)
//            "逼" -> mp = MediaPlayer.create(context, R.raw.bi1)
//            "鼻" -> mp = MediaPlayer.create(context, R.raw.bi2)
//            "比", "彼", "笔", "鄙" -> mp = MediaPlayer.create(context, R.raw.bi3)
//            "币", "必", "毕", "闭", "毙", "碧", "蔽", "弊", "壁", "避", "臂" -> mp =
//                MediaPlayer.create(context, R.raw.bi4)
//            "边", "编", "鞭" -> mp = MediaPlayer.create(context, R.raw.bian1)
//            "扁" -> mp = MediaPlayer.create(context, R.raw.bian3)
//            "变", "便", "遍", "辨", "辩", "辫" -> mp = MediaPlayer.create(context, R.raw.bian4)
...
//            "宾", "滨" -> mp = MediaPlayer.create(context, R.raw.bin1)
...
//            "拨", "波", "玻", "菠", "播" -> mp = MediaPlayer.create(context, R.raw.bo1)
//            "驳", "泊", "脖", "博", "搏", "膊" -> mp = MediaPlayer.create(context, R.raw.bo2)
//            "卜", "补", "捕" -> mp = MediaPlayer.create(context, R.raw.bu3)
//            "不", "布", "步", "怖", "部" -> mp = MediaPlayer.create(context, R.raw.bu4)
//            //c
//            "擦" -> mp = MediaPlayer.create(context, R.raw.ca1)
//            "猜" -> mp = MediaPlayer.create(context, R.raw.cai1)
//            "才", "材", "财", "裁" -> mp = MediaPlayer.create(context, R.raw.cai2)
//            "采", "彩", "睬", "踩" -> mp = MediaPlayer.create(context, R.raw.cai3)
//            "菜" -> mp = MediaPlayer.create(context, R.raw.cai4)
//            "参", "餐" -> mp = MediaPlayer.create(context, R.raw.can1)
...
//            "藏" -> mp = MediaPlayer.create(context, R.raw.cang2)
//            "操" -> mp = MediaPlayer.create(context, R.raw.cao1)
//            "槽" -> mp = MediaPlayer.create(context, R.raw.cao2)
...
//            "茶", "查", "察" -> mp = MediaPlayer.create(context, R.raw.cha2)
...
//            "馋", "缠" -> mp = MediaPlayer.create(context, R.raw.chan2)
//            "产", "铲" -> mp = MediaPlayer.create(context, R.raw.chan3)
//            "颤" -> mp = MediaPlayer.create(context, R.raw.chan4)
...
//            "朝", "潮" -> mp = MediaPlayer.create(context, R.raw.chao2)
...
//            "仇", "绸", "酬", "稠", "愁", "筹" -> mp = MediaPlayer.create(context, R.raw.chou2)
...
//            "础", "储", "楚" -> mp = MediaPlayer.create(context, R.raw.chu3)
//            "处", "畜", "触" -> mp = MediaPlayer.create(context, R.raw.chu4)
...
//            "垂", "锤" -> mp = MediaPlayer.create(context, R.raw.chui2)
//            "春" -> mp = MediaPlayer.create(context, R.raw.chun1)
//            "纯", "唇" -> mp = MediaPlayer.create(context, R.raw.chun2)
//            "蠢" -> mp = MediaPlayer.create(context, R.raw.chun3)
//            "词", "辞", "慈", "磁" -> mp = MediaPlayer.create(context, R.raw.ci2)
//            "此" -> mp = MediaPlayer.create(context, R.raw.ci3)
//            "次", "刺" -> mp = MediaPlayer.create(context, R.raw.ci4)
//            "匆", "葱", "聪" -> mp = MediaPlayer.create(context, R.raw.cong1)
...
//            "促", "醋" -> mp = MediaPlayer.create(context, R.raw.cu4)
//            "窜" -> mp = MediaPlayer.create(context, R.raw.cuan4)
//            "催", "摧" -> mp = MediaPlayer.create(context, R.raw.cui1)
//            "脆", "翠" -> mp = MediaPlayer.create(context, R.raw.cui4)
...
//            "错" -> mp = MediaPlayer.create(context, R.raw.cuo4)
//            //d
...
//            "代", "带", "贷", "待", "怠", "袋", "戴" -> mp = MediaPlayer.create(context, R.raw.dai4)
...
//            "导", "岛", "倒", "蹈" -> mp = MediaPlayer.create(context, R.raw.dao3)
//            "到", "盗", "悼", "道", "稻" -> mp = MediaPlayer.create(context, R.raw.dao4)
//            "的" -> mp = MediaPlayer.create(context, R.raw.de0)
//            "得", "德" -> mp = MediaPlayer.create(context, R.raw.de2)
//            "灯", "登" -> mp = MediaPlayer.create(context, R.raw.deng1)
//            "等" -> mp = MediaPlayer.create(context, R.raw.deng3)
//            "凳" -> mp = MediaPlayer.create(context, R.raw.deng4)
//            "低", "堤", "滴" -> mp = MediaPlayer.create(context, R.raw.di1)
...
//            "颠" -> mp = MediaPlayer.create(context, R.raw.dian1)
//            "典", "点" -> mp = MediaPlayer.create(context, R.raw.dian3)
//            "电", "店", "垫", "殿" -> mp = MediaPlayer.create(context, R.raw.dian4)
//            "叼", "雕" -> mp = MediaPlayer.create(context, R.raw.diao1)
//            "吊", "钓", "调", "掉" -> mp = MediaPlayer.create(context, R.raw.diao4)
//            "爹", "跌" -> mp = MediaPlayer.create(context, R.raw.die1)
//            "叠", "蝶" -> mp = MediaPlayer.create(context, R.raw.die2)
...
//            "董", "懂" -> mp = MediaPlayer.create(context, R.raw.dong3)
...
//            "督" -> mp = MediaPlayer.create(context, R.raw.du1)
...
//            "端" -> mp = MediaPlayer.create(context, R.raw.duan1)
//            "短" -> mp = MediaPlayer.create(context, R.raw.duan3)
//            "段", "断", "缎", "锻" -> mp = MediaPlayer.create(context, R.raw.duan4)
//            "堆" -> mp = MediaPlayer.create(context, R.raw.dui1)
//            "队", "对" -> mp = MediaPlayer.create(context, R.raw.dui4)
//            "吨", "蹲" -> mp = MediaPlayer.create(context, R.raw.dun1)
...
//            "朵", "躲" -> mp = MediaPlayer.create(context, R.raw.duo3)
//            "惰" -> mp = MediaPlayer.create(context, R.raw.duo4)
//            //e
//            "鹅", "蛾", "额" -> mp = MediaPlayer.create(context, R.raw.e2)
...
//            "帆", "番", "翻" -> mp = MediaPlayer.create(context, R.raw.fan1)
//            "凡", "泛", "烦", "繁" -> mp = MediaPlayer.create(context, R.raw.fan2)
...
//            "丰", "风", "封", "疯", "峰", "锋", "蜂" -> mp = MediaPlayer.create(context, R.raw.feng1)
//            "逢" -> mp = MediaPlayer.create(context, R.raw.feng2)
//            "讽" -> mp = MediaPlayer.create(context, R.raw.feng3)
//            "凤", "奉", "缝" -> mp = MediaPlayer.create(context, R.raw.feng4)
...
//            "伏", "扶", "服", "俘", "浮", "符", "幅", "福" -> mp = MediaPlayer.create(context, R.raw.fu2)
//            "抚", "斧", "府", "俯", "辅", "腐" -> mp = MediaPlayer.create(context, R.raw.fu3)
//            "父", "付", "负", "妇", "附", "咐", "赴", "复", "副", "傅", "富", "腹", "覆" -> mp =
//                MediaPlayer.create(context, R.raw.fu4)
//            //g
//            "该" -> mp = MediaPlayer.create(context, R.raw.gai1)
//            "改" -> mp = MediaPlayer.create(context, R.raw.gai3)
//            "盖", "溉", "概" -> mp = MediaPlayer.create(context, R.raw.gai4)
//            "甘", "肝", "竿" -> mp = MediaPlayer.create(context, R.raw.gan1)
//            "杆", "秆", "赶", "敢", "感" -> mp = MediaPlayer.create(context, R.raw.gan3)
...
//            "高", "膏", "糕" -> mp = MediaPlayer.create(context, R.raw.gao1)
//            "搞", "稿" -> mp = MediaPlayer.create(context, R.raw.gao3)
//            "告" -> mp = MediaPlayer.create(context, R.raw.gao4)
//            "哥", "胳", "鸽", "搁", "割", "歌" -> mp = MediaPlayer.create(context, R.raw.ge1)
...
//            "根", "跟" -> mp = MediaPlayer.create(context, R.raw.gen1)
...
//            "古", "谷", "股", "骨", "鼓" -> mp = MediaPlayer.create(context, R.raw.gu3)
...
//            "馆", "管" -> mp = MediaPlayer.create(context, R.raw.guan3)
//            "贯", "惯", "灌", "罐" -> mp = MediaPlayer.create(context, R.raw.guan4)
...
//            "柜", "贵", "桂", "跪" -> mp = MediaPlayer.create(context, R.raw.gui4)
//            "滚" -> mp = MediaPlayer.create(context, R.raw.gun3)
...
//            "果", "裹" -> mp = MediaPlayer.create(context, R.raw.guo3)
...
//            "号", "毫", "豪" -> mp = MediaPlayer.create(context, R.raw.hao2)
...
//            "恒", "横", "衡" -> mp = MediaPlayer.create(context, R.raw.heng2)
...
//            "狐", "胡", "壶", "湖", "蝴", "糊" -> mp = MediaPlayer.create(context, R.raw.hu2)
...
//            "怀", "槐" -> mp = MediaPlayer.create(context, R.raw.huai2)
...
//            "皇", "黄", "煌" -> mp = MediaPlayer.create(context, R.raw.huang2)
...
//            "悔", "毁" -> mp = MediaPlayer.create(context, R.raw.hui3)
//            "汇", "会", "绘", "贿", "惠", "慧" -> mp = MediaPlayer.create(context, R.raw.hui4)
//            "昏", "婚" -> mp = MediaPlayer.create(context, R.raw.hun1)
//            "浑", "魂" -> mp = MediaPlayer.create(context, R.raw.hun2)
...
//            //i
//            //j
//            "击", "饥", "圾", "机", "肌", "鸡", "积", "基", "激" -> mp =
//                MediaPlayer.create(context, R.raw.ji1)
//            "及", "吉", "级", "极", "即", "急", "疾", "集", "籍" -> mp =
//                MediaPlayer.create(context, R.raw.ji2)
//            "几", "己", "挤", "脊" -> mp = MediaPlayer.create(context, R.raw.ji3)
//            "计", "记", "纪", "技", "忌", "际", "季", "剂", "迹", "济", "既", "继", "寄", "绩" -> mp =
//                MediaPlayer.create(context, R.raw.ji4)
//            "加", "夹", "佳", "家", "嘉" -> mp = MediaPlayer.create(context, R.raw.jia1)
//            "甲", "假" -> mp = MediaPlayer.create(context, R.raw.jia3)
//            "价", "驾", "架", "嫁", "稼" -> mp = MediaPlayer.create(context, R.raw.jia4)
//            "尖", "奸", "歼", "坚", "间", "肩", "艰", "监", "兼", "煎" -> mp =
//                MediaPlayer.create(context, R.raw.jian1)
//            "拣", "茧", "俭", "捡", "检", "减", "剪", "简" -> mp = MediaPlayer.create(context, R.raw.jian3)
//            "见", "件", "建", "荐", "贱", "剑", "健", "舰", "渐", "践", "鉴", "键", "箭" -> mp =
//                MediaPlayer.create(context, R.raw.jian4)
//            "江", "姜", "浆", "僵", "疆" -> mp = MediaPlayer.create(context, R.raw.jiang1)
//            "讲", "奖", "桨" -> mp = MediaPlayer.create(context, R.raw.jiang3)
//            "匠", "降", "将", "酱" -> mp = MediaPlayer.create(context, R.raw.jiang4)
//            "交", "郊", "浇", "娇", "骄", "胶", "椒", "焦", "蕉" -> mp =
//                MediaPlayer.create(context, R.raw.jiao1)
//            "嚼" -> mp = MediaPlayer.create(context, R.raw.jiao2)
//            "角", "狡", "饺", "绞", "脚", "搅", "缴" -> mp = MediaPlayer.create(context, R.raw.jiao3)
//            "叫", "轿", "较", "教" -> mp = MediaPlayer.create(context, R.raw.jiao4)
//            "阶", "皆", "接", "揭", "街" -> mp = MediaPlayer.create(context, R.raw.jie1)
//            "节", "杰", "洁", "结", "捷", "截", "竭" -> mp = MediaPlayer.create(context, R.raw.jie2)
//            "姐", "解" -> mp = MediaPlayer.create(context, R.raw.jie3)
//            "介", "戒", "届", "界", "借" -> mp = MediaPlayer.create(context, R.raw.jie4)
//            "巾", "斤", "今", "金", "津", "筋" -> mp = MediaPlayer.create(context, R.raw.jin1)
//            "仅", "紧", "锦", "谨" -> mp = MediaPlayer.create(context, R.raw.jin3)
//            "尽", "进", "近", "劲", "晋", "浸", "禁" -> mp = MediaPlayer.create(context, R.raw.jin4)
//            "茎", "京", "经", "惊", "晶", "睛", "精" -> mp = MediaPlayer.create(context, R.raw.jing1)
//            "井", "颈", "景", "警" -> mp = MediaPlayer.create(context, R.raw.jing3)
//            "径", "净", "竞", "竟", "敬", "静", "境", "镜" -> mp = MediaPlayer.create(context, R.raw.jing4)
//            "纠", "究", "揪" -> mp = MediaPlayer.create(context, R.raw.jiu1)
//            "九", "久", "酒" -> mp = MediaPlayer.create(context, R.raw.jiu3)
//            "旧", "救", "就", "舅" -> mp = MediaPlayer.create(context, R.raw.jiu4)
//            "拘", "居", "鞠" -> mp = MediaPlayer.create(context, R.raw.ju1)
//            "局", "菊", "橘" -> mp = MediaPlayer.create(context, R.raw.ju2)
//            "举" -> mp = MediaPlayer.create(context, R.raw.ju3)
//            "巨", "句", "拒", "具", "矩", "俱", "剧", "据", "距", "惧", "锯", "聚" -> mp =
...
//            "康", "糠" -> mp = MediaPlayer.create(context, R.raw.kang1)
...
//            "靠" -> mp = MediaPlayer.create(context, R.raw.kao4)
//            "科", "棵", "颗" -> mp = MediaPlayer.create(context, R.raw.ke1)
...
//            "库", "裤", "酷" -> mp = MediaPlayer.create(context, R.raw.ku4)
//            "夸" -> mp = MediaPlayer.create(context, R.raw.kua1)
//            "垮" -> mp = MediaPlayer.create(context, R.raw.kua3)
//            "挎", "跨" -> mp = MediaPlayer.create(context, R.raw.kua4)
...
//            "腊", "蜡", "辣" -> mp = MediaPlayer.create(context, R.raw.la4)
//            "来" -> mp = MediaPlayer.create(context, R.raw.lai2)
//            "赖" -> mp = MediaPlayer.create(context, R.raw.lai4)
//            "兰", "拦", "栏", "蓝", "篮" -> mp = MediaPlayer.create(context, R.raw.lan2)
//            "览", "懒" -> mp = MediaPlayer.create(context, R.raw.lan3)
//            "烂", "滥" -> mp = MediaPlayer.create(context, R.raw.lan4)
...
//            "雷" -> mp = MediaPlayer.create(context, R.raw.lei2)
...
//            "厘", "狸", "离", "梨", "犁", "璃", "黎" -> mp = MediaPlayer.create(context, R.raw.li2)
...
//            "伶", "灵", "铃", "陵", "零", "龄" -> mp = MediaPlayer.create(context, R.raw.ling2)
//            "岭", "领" -> mp = MediaPlayer.create(context, R.raw.ling3)
//            "另", "令" -> mp = MediaPlayer.create(context, R.raw.ling4)
//            "溜" -> mp = MediaPlayer.create(context, R.raw.liu1)
//            "刘", "留", "流", "榴" -> mp = MediaPlayer.create(context, R.raw.liu2)
...
//            "楼" -> mp = MediaPlayer.create(context, R.raw.lou2)
//            "搂" -> mp = MediaPlayer.create(context, R.raw.lou3)
//            "漏" -> mp = MediaPlayer.create(context, R.raw.lou4)
//            "炉" -> mp = MediaPlayer.create(context, R.raw.lu2)
//            "虏", "鲁" -> mp = MediaPlayer.create(context, R.raw.lu3)
//            "陆", "录", "鹿", "碌", "路", "露" -> mp = MediaPlayer.create(context, R.raw.lu4)
...
//            "罗", "萝", "锣", "箩", "骡", "螺" -> mp = MediaPlayer.create(context, R.raw.luo2)
...
//            "律", "虑", "率", "绿", "滤" -> mp = MediaPlayer.create(context, R.raw.lv4)
//            //m
...
//            "蛮", "馒", "瞒" -> mp = MediaPlayer.create(context, R.raw.man2)
//            "满" -> mp = MediaPlayer.create(context, R.raw.man3)
//            "漫", "慢" -> mp = MediaPlayer.create(context, R.raw.man4)
...
//            "茂", "冒", "贸", "帽", "貌" -> mp = MediaPlayer.create(context, R.raw.mao4)
//            "么" -> mp = MediaPlayer.create(context, R.raw.me0)
//            "没", "眉", "梅", "煤", "霉" -> mp = MediaPlayer.create(context, R.raw.mei2)
...
//            "萌", "蒙", "盟" -> mp = MediaPlayer.create(context, R.raw.meng2)
...
//            "秘", "密", "蜜" -> mp = MediaPlayer.create(context, R.raw.mi4)
...
//            "灭", "蔑" -> mp = MediaPlayer.create(context, R.raw.mie4)
...
//            "摸" -> mp = MediaPlayer.create(context, R.raw.mo1)
//            "模", "膜", "摩", "磨", "魔" -> mp = MediaPlayer.create(context, R.raw.mo2)
//            "抹" -> mp = MediaPlayer.create(context, R.raw.mo3)
//            "末", "沫", "莫", "漠", "墨", "默" -> mp = MediaPlayer.create(context, R.raw.mo4)
...
//            "木", "目", "牧", "墓", "幕", "慕", "暮" -> mp = MediaPlayer.create(context, R.raw.mu4)
//            //n
...
//            "囊" -> mp = MediaPlayer.create(context, R.raw.nang2)
...
//            "嫩" -> mp = MediaPlayer.create(context, R.raw.nen4)
...
//            "酿" -> mp = MediaPlayer.create(context, R.raw.niang4)
...
//            "宁", "凝" -> mp = MediaPlayer.create(context, R.raw.ning2)
...
//            "暖" -> mp = MediaPlayer.create(context, R.raw.nuan3)
...
//            "攀" -> mp = MediaPlayer.create(context, R.raw.pan1)
...
//            "朋", "棚", "蓬", "膨" -> mp = MediaPlayer.create(context, R.raw.peng2)
//            "捧" -> mp = MediaPlayer.create(context, R.raw.peng3)
//            "碰" -> mp = MediaPlayer.create(context, R.raw.peng4)
//            "批", "披", "劈" -> mp = MediaPlayer.create(context, R.raw.pi1)
//            "皮", "疲", "脾" -> mp = MediaPlayer.create(context, R.raw.pi2)
//            "匹" -> mp = MediaPlayer.create(context, R.raw.pi3)
//            "辟", "僻" -> mp = MediaPlayer.create(context, R.raw.pi4)
//            "偏", "篇" -> mp = MediaPlayer.create(context, R.raw.pian1)
//            "片", "骗" -> mp = MediaPlayer.create(context, R.raw.pian4)
//            "漂", "飘" -> mp = MediaPlayer.create(context, R.raw.piao1)
//            "票" -> mp = MediaPlayer.create(context, R.raw.piao4)
//            "撇" -> mp = MediaPlayer.create(context, R.raw.pie3)
...
//            "迫", "破", "魄" -> mp = MediaPlayer.create(context, R.raw.po4)
...
//            "朴", "普", "谱" -> mp = MediaPlayer.create(context, R.raw.pu3)
//            "铺" -> mp = MediaPlayer.create(context, R.raw.pu4)
//            //q
//            "七", "妻", "戚", "期", "欺", "漆" -> mp = MediaPlayer.create(context, R.raw.qi1)
//            "齐", "其", "奇", "骑", "棋", "旗" -> mp = MediaPlayer.create(context, R.raw.qi2)
//            "乞", "岂", "企", "启", "起" -> mp = MediaPlayer.create(context, R.raw.qi3)
//            "气", "弃", "汽", "砌", "器" -> mp = MediaPlayer.create(context, R.raw.qi4)
//            "洽", "恰" -> mp = MediaPlayer.create(context, R.raw.qia4)
//            "千", "迁", "牵", "铅", "谦", "签" -> mp = MediaPlayer.create(context, R.raw.qian1)
//            "前", "钱", "钳", "潜" -> mp = MediaPlayer.create(context, R.raw.qian2)
//            "浅", "遣" -> mp = MediaPlayer.create(context, R.raw.qian3)
//            "欠", "歉" -> mp = MediaPlayer.create(context, R.raw.qian4)
//            "枪", "腔" -> mp = MediaPlayer.create(context, R.raw.qiang1)
//            "强" -> mp = MediaPlayer.create(context, R.raw.qiang2)
//            "抢", "墙" -> mp = MediaPlayer.create(context, R.raw.qiang3)
//            "悄", "锹", "敲" -> mp = MediaPlayer.create(context, R.raw.qiao1)
//            "乔", "侨", "桥", "瞧" -> mp = MediaPlayer.create(context, R.raw.qiao2)
...
//            "琴", "禽", "勤" -> mp = MediaPlayer.create(context, R.raw.qin2)
//            "青", "轻", "倾", "清", "蜻" -> mp = MediaPlayer.create(context, R.raw.qing1)
...
//            "去", "趣" -> mp = MediaPlayer.create(context, R.raw.qu4)
...
//            "雀", "确", "鹊" -> mp = MediaPlayer.create(context, R.raw.que4)
//            "裙", "群" -> mp = MediaPlayer.create(context, R.raw.qun2)
//            //r
//            "然", "燃" -> mp = MediaPlayer.create(context, R.raw.ran2)
//            "染" -> mp = MediaPlayer.create(context, R.raw.ran3)
//            "壤", "嚷" -> mp = MediaPlayer.create(context, R.raw.rang3)
...
//            "荣", "绒", "容", "熔", "融" -> mp = MediaPlayer.create(context, R.raw.rong2)
...
//            "锐", "瑞" -> mp = MediaPlayer.create(context, R.raw.rui4)
//            "润" -> mp = MediaPlayer.create(context, R.raw.run4)
//            "若", "弱" -> mp = MediaPlayer.create(context, R.raw.ruo4)
//            //s
//            "撒" -> mp = MediaPlayer.create(context, R.raw.sa1)
//            "洒" -> mp = MediaPlayer.create(context, R.raw.sa3)
//            "塞", "赛" -> mp = MediaPlayer.create(context, R.raw.sai4)
...
//            "嗓" -> mp = MediaPlayer.create(context, R.raw.sang3)
...
//            "傻" -> mp = MediaPlayer.create(context, R.raw.sha3)
...
//            "裳" -> mp = MediaPlayer.create(context, R.raw.shang0)
...
//            "设", "社", "射", "涉", "摄" -> mp = MediaPlayer.create(context, R.raw.she4)
...
//            "肾", "甚", "渗", "慎" -> mp = MediaPlayer.create(context, R.raw.shen4)
...
//            "是", "士", "氏", "示", "世", "市", "式", "势", "事", "侍", "饰", "试", "视", "柿", "是", "适", "室", "逝", "释", "誓" -> mp =
...
//            "寿", "受", "授", "售", "兽", "瘦" -> mp = MediaPlayer.create(context, R.raw.shou4)
//            "书", "叔", "殊", "梳", "舒", "疏", "输", "蔬" -> mp = MediaPlayer.create(context, R.raw.shu1)
//            "熟" -> mp = MediaPlayer.create(context, R.raw.shu2)
//            "暑", "属", "鼠", "薯" -> mp = MediaPlayer.create(context, R.raw.shu3)
//            "术", "束", "述", "树", "竖", "数" -> mp = MediaPlayer.create(context, R.raw.shu4)
//            "刷" -> mp = MediaPlayer.create(context, R.raw.shua1)
//            "耍" -> mp = MediaPlayer.create(context, R.raw.shua3)
//            "衰", "摔" -> mp = MediaPlayer.create(context, R.raw.shuai1)
...
//            "唐", "堂", "塘", "膛", "糖" -> mp = MediaPlayer.create(context, R.raw.tang2)
//            "倘", "躺" -> mp = MediaPlayer.create(context, R.raw.tang3)
//            "烫", "趟" -> mp = MediaPlayer.create(context, R.raw.tang4)
//            "涛", "掏", "滔" -> mp = MediaPlayer.create(context, R.raw.tao1)
...
//            "疼", "腾" -> mp = MediaPlayer.create(context, R.raw.teng2)
//            "梯", "踢" -> mp = MediaPlayer.create(context, R.raw.ti1)
//            "提", "题", "蹄" -> mp = MediaPlayer.create(context, R.raw.ti2)
...
//            "田", "甜", "填" -> mp = MediaPlayer.create(context, R.raw.tian2)
//            "挑" -> mp = MediaPlayer.create(context, R.raw.tiao1)
//            "条" -> mp = MediaPlayer.create(context, R.raw.tiao2)
//            "跳" -> mp = MediaPlayer.create(context, R.raw.tiao4)
...
//            "腿" -> mp = MediaPlayer.create(context, R.raw.tui3)
...
//            "挽", "晚", "碗" -> mp = MediaPlayer.create(context, R.raw.wan3)
...
//            "五", "午", "伍", "武", "侮", "舞" -> mp = MediaPlayer.create(context, R.raw.wu3)
//            "勿", "务", "物", "误", "悟", "雾" -> mp = MediaPlayer.create(context, R.raw.wu4)
//            //x
//            "夕", "西", "吸", "希", "析", "牺", "息", "悉", "惜", "稀", "锡", "溪", "熄", "膝" -> mp =
...
//            "虾", "瞎" -> mp = MediaPlayer.create(context, R.raw.xia1)
//            "峡", "狭", "霞" -> mp = MediaPlayer.create(context, R.raw.xia2)
//            "下", "吓", "夏" -> mp = MediaPlayer.create(context, R.raw.xia4)
//            "仙", "先", "纤", "掀", "鲜" -> mp = MediaPlayer.create(context, R.raw.xian1)
//            "闲", "贤", "弦", "咸", "衔", "嫌" -> mp = MediaPlayer.create(context, R.raw.xian2)
//            "显", "险" -> mp = MediaPlayer.create(context, R.raw.xian3)
//            "县", "现", "限", "线", "宪", "陷", "馅", "羡", "献" -> mp =
//                MediaPlayer.create(context, R.raw.xian4)
//            "乡", "相", "香", "箱" -> mp = MediaPlayer.create(context, R.raw.xiang1)
//            "详", "祥" -> mp = MediaPlayer.create(context, R.raw.xiang2)
//            "享", "响", "想" -> mp = MediaPlayer.create(context, R.raw.xiang3)
//            "向", "项", "巷", "象", "像", "橡" -> mp = MediaPlayer.create(context, R.raw.xiang4)
...
//            "须", "虚", "需" -> mp = MediaPlayer.create(context, R.raw.xu1)
//            "徐" -> mp = MediaPlayer.create(context, R.raw.xu2)
//            "许" -> mp = MediaPlayer.create(context, R.raw.xu3)
//            "序", "叙", "绪", "续", "絮", "蓄" -> mp = MediaPlayer.create(context, R.raw.xu4)
...
//            "延", "言", "岩", "炎", "沿", "研", "盐", "颜" -> mp = MediaPlayer.create(context, R.raw.yan2)
//            "掩", "眼", "演" -> mp = MediaPlayer.create(context, R.raw.yan3)
//            "厌", "艳", "宴", "验", "雁", "焰", "燕" -> mp = MediaPlayer.create(context, R.raw.yan4)
...
//            "妖", "腰", "邀" -> mp = MediaPlayer.create(context, R.raw.yao1)
//            "窑", "谣", "摇", "遥" -> mp = MediaPlayer.create(context, R.raw.yao2)
//            "咬" -> mp = MediaPlayer.create(context, R.raw.yao3)
//            "药", "要", "钥", "耀" -> mp = MediaPlayer.create(context, R.raw.yao4)
...
//            "仪", "宜", "姨", "移", "遗", "疑" -> mp = MediaPlayer.create(context, R.raw.yi2)
//            "乙", "已", "以", "蚁", "倚", "椅" -> mp = MediaPlayer.create(context, R.raw.yi3)
//            "亿", "义", "艺", "忆", "议", "亦", "异", "役", "译", "易", "疫", "益", "谊", "意", "毅", "翼" -> mp =
...
//            "英", "樱", "鹰" -> mp = MediaPlayer.create(context, R.raw.ying1)
//            "迎", "盈", "营", "蝇", "赢" -> mp = MediaPlayer.create(context, R.raw.ying2)
//            "影" -> mp = MediaPlayer.create(context, R.raw.ying3)
...
//            "于", "余", "鱼", "娱", "渔", "愉", "榆", "愚" -> mp = MediaPlayer.create(context, R.raw.yu2)
//            "与", "予", "屿", "宇", "羽", "雨", "语" -> mp = MediaPlayer.create(context, R.raw.yu3)
//            "玉", "育", "狱", "浴", "预", "域", "欲", "遇", "御", "裕", "愈", "誉" -> mp =
//                MediaPlayer.create(context, R.raw.yu4)
//            "冤" -> mp = MediaPlayer.create(context, R.raw.yuan1)
//            "元", "园", "员", "原", "圆", "援", "缘", "源" -> mp = MediaPlayer.create(context, R.raw.yuan2)
//            "远" -> mp = MediaPlayer.create(context, R.raw.yuan3)
//            "怨", "院", "愿" -> mp = MediaPlayer.create(context, R.raw.yuan4)
...
//            "孕", "运", "韵" -> mp = MediaPlayer.create(context, R.raw.yun4)
//            //z
...
//            "暂", "赞" -> mp = MediaPlayer.create(context, R.raw.zan4)
//            "脏" -> mp = MediaPlayer.create(context, R.raw.zang1)
//            "葬" -> mp = MediaPlayer.create(context, R.raw.zang4)
//            "遭", "糟" -> mp = MediaPlayer.create(context, R.raw.zao1)
//            "早", "枣", "澡" -> mp = MediaPlayer.create(context, R.raw.zao3)
//            "皂", "灶", "造", "燥", "躁" -> mp = MediaPlayer.create(context, R.raw.zao4)
...
//            "曾", "增" -> mp = MediaPlayer.create(context, R.raw.zeng1)
//            "赠" -> mp = MediaPlayer.create(context, R.raw.zeng4)
...
//            "炸", "榨" -> mp = MediaPlayer.create(context, R.raw.zha4)
//            "摘" -> mp = MediaPlayer.create(context, R.raw.zhai1)
//            "宅" -> mp = MediaPlayer.create(context, R.raw.zhai2)
//            "窄" -> mp = MediaPlayer.create(context, R.raw.zhai3)
//            "债", "寨" -> mp = MediaPlayer.create(context, R.raw.zhai4)
...
//            "丈", "仗", "帐", "胀", "障" -> mp = MediaPlayer.create(context, R.raw.zhang4)
//            "招", "着" -> mp = MediaPlayer.create(context, R.raw.zhao1)
//            "找" -> mp = MediaPlayer.create(context, R.raw.zhao3)
//            "召", "兆", "赵", "照", "罩" -> mp = MediaPlayer.create(context, R.raw.zhao4)
//            "遮" -> mp = MediaPlayer.create(context, R.raw.zhe1)
...
//            "阵", "振", "震", "镇" -> mp = MediaPlayer.create(context, R.raw.zhen4)
//            "争", "征", "睁", "筝", "蒸" -> mp = MediaPlayer.create(context, R.raw.zheng1)
//            "整" -> mp = MediaPlayer.create(context, R.raw.zheng3)
//            "正", "证", "郑", "政", "挣", "症" -> mp = MediaPlayer.create(context, R.raw.zheng4)
//            "之", "支", "汁", "只", "芝", "枝", "知", "肢", "织", "脂", "蜘" -> mp =
...
//            "至", "帜", "制", "质", "治", "致", "秩", "智", "置" -> mp =
//                MediaPlayer.create(context, R.raw.zhi4)
...
//            "赚" -> mp = MediaPlayer.create(context, R.raw.zhuan4)
//            "庄", "装" -> mp = MediaPlayer.create(context, R.raw.zhuang1)
//            "壮", "状", "撞" -> mp = MediaPlayer.create(context, R.raw.zhuang4)
...
//            "宗", "棕", "踪" -> mp = MediaPlayer.create(context, R.raw.zong1)
...
//            "嘴" -> mp = MediaPlayer.create(context, R.raw.zui3)
//            "最", "罪", "醉" -> mp = MediaPlayer.create(context, R.raw.zui4)
//            "尊", "遵" -> mp = MediaPlayer.create(context, R.raw.zun1)
