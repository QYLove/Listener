...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "采", "彩", "睬" -> mp = MediaPlayer.create(context, R.raw.cai3)
            ...
            "叠" -> mp = MediaPlayer.create(context, R.raw.die2)
            ...
            //e
            "鹅", "蛾" -> mp = MediaPlayer.create(context, R.raw.e2)
            ...
            "搞" -> mp = MediaPlayer.create(context, R.raw.gao3)
            ...
            "厘", "狸", "离", "梨", "犁", "璃" -> mp = MediaPlayer.create(context, R.raw.li2)
            ...
            "蛮", "馒" -> mp = MediaPlayer.create(context, R.raw.man2)
            ...
            "没", "眉", "梅", "煤" -> mp = MediaPlayer.create(context, R.raw.mei2)
            ...
            "模", "膜" -> mp = MediaPlayer.create(context, R.raw.mo2)
            "抹" -> mp = MediaPlayer.create(context, R.raw.mo3)
            "末", "沫", "莫", "漠" -> mp = MediaPlayer.create(context, R.raw.mo4)
            ...
            "书", "叔", "殊", "梳", "舒", "疏", "输" -> mp = MediaPlayer.create(context, R.raw.shu1)
            ...
            "唐", "堂", "塘" -> mp = MediaPlayer.create(context, R.raw.tang2)
            ...
            "向", "项", "巷", "象", "像" -> mp = MediaPlayer.create(context, R.raw.xiang4)
            ...
            "协", "邪", "胁", "斜", "携" -> mp = MediaPlayer.create(context, R.raw.xie2)
            ...
            "亿", "义", "艺", "忆", "议", "亦", "异", "役", "译", "易", "疫", "益", "谊", "意" -> mp =
            ...
            "最", "罪" -> mp = MediaPlayer.create(context, R.raw.zui4)
