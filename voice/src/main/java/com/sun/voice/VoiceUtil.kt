...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "坝"->mp= MediaPlayer.create(context,R.raw.ba4)
            "白" -> mp = MediaPlayer.create(context, R.raw.bai2)
            "百","伯" -> mp = MediaPlayer.create(context, R.raw.bai3)
            "办", "半","扮","伴" -> mp = MediaPlayer.create(context, R.raw.ban4)
            ...
            "驳"->mp= MediaPlayer.create(context,R.raw.bo2)
            "卜","补" -> mp = MediaPlayer.create(context, R.raw.bu3)
            "不", "布","步" -> mp = MediaPlayer.create(context, R.raw.bu4)
            //c
            ...
            "吵"->mp= MediaPlayer.create(context,R.raw.chao3)
            ...
            "成","呈" -> mp = MediaPlayer.create(context, R.raw.cheng2)
            ...
            "吹"->mp= MediaPlayer.create(context,R.raw.chui1)
            ...
            "旦","但" -> mp = MediaPlayer.create(context, R.raw.dan4)
            ...
            "犯","饭" -> mp = MediaPlayer.create(context, R.raw.fan4)
            "方" -> mp = MediaPlayer.create(context, R.raw.fang1)
            "防","坊","妨" -> mp = MediaPlayer.create(context, R.raw.fang2)
            ...
            "伏","扶" -> mp = MediaPlayer.create(context, R.raw.fu2)
            "抚"->mp= MediaPlayer.create(context,R.raw.fu3)
            "父", "付", "负", "妇","附" -> mp = MediaPlayer.create(context, R.raw.fu4)
            //g
            "改"->mp= MediaPlayer.create(context,R.raw.gai3)
            "甘","肝" -> mp = MediaPlayer.create(context, R.raw.gan1)
            "杆"->mp= MediaPlayer.create(context,R.raw.gan3)
            ...
            "共","贡" -> mp = MediaPlayer.create(context, R.raw.gong4)
            "勾","沟" -> mp = MediaPlayer.create(context, R.raw.gou1)
            "估"->mp= MediaPlayer.create(context,R.raw.gu1)
            "古","谷" -> mp = MediaPlayer.create(context, R.raw.gu3)
            ...
            "归","龟" -> mp = MediaPlayer.create(context, R.raw.gui1)
            ...
            "禾", "合","何" -> mp = MediaPlayer.create(context, R.raw.he2)
            ...
            "计", "记", "纪","技","忌","际" -> mp = MediaPlayer.create(context, R.raw.ji4)
            ...
            "尖", "奸","歼","坚","间" -> mp = MediaPlayer.create(context, R.raw.jian1)
            ...
            "介","戒" -> mp = MediaPlayer.create(context, R.raw.jie4)
            ...
            "巨", "句","拒" -> mp = MediaPlayer.create(context, R.raw.ju4)
            ...
            "抗"->mp= MediaPlayer.create(context,R.raw.kang4)
            ...
            "旷","况"->mp= MediaPlayer.create(context,R.raw.kuang4)
            ...
            "力", "历", "厉", "立","丽","励","利" -> mp = MediaPlayer.create(context, R.raw.li4)
            "连"->mp= MediaPlayer.create(context,R.raw.lian2)
            ...
            "邻"->mp= MediaPlayer.create(context,R.raw.lin2)
            ...
            "陆"->mp= MediaPlayer.create(context,R.raw.lu4)
            ...
            "迈","麦" -> mp = MediaPlayer.create(context, R.raw.mai4)
            ...
            "妙"->mp= MediaPlayer.create(context,R.raw.miao4)
            ...
            "批"->mp= MediaPlayer.create(context,R.raw.pi1)
            ...
            "平","评" -> mp = MediaPlayer.create(context, R.raw.ping2)
            ...
            "区","驱" -> mp = MediaPlayer.create(context, R.raw.qu1)
            ...
            "山","删" -> mp = MediaPlayer.create(context, R.raw.shan1)
            ...
            "沈"->mp= MediaPlayer.create(context,R.raw.shen3)
            ...
            "十", "石","时","识" -> mp = MediaPlayer.create(context, R.raw.shi2)
            ...
            "寿"->mp= MediaPlayer.create(context,R.raw.shou4)
            "书" -> mp = MediaPlayer.create(context, R.raw.shu1)
            "术","束" -> mp = MediaPlayer.create(context, R.raw.shu4)
            ...
            "诉"->mp= MediaPlayer.create(context,R.raw.su4)
            ...
            "丸","完" -> mp = MediaPlayer.create(context, R.raw.wan2)
            ...
            "妄","忘" -> mp = MediaPlayer.create(context, R.raw.wang4)
            "危" -> mp = MediaPlayer.create(context, R.raw.wei1)
            "为","违","围" -> mp = MediaPlayer.create(context, R.raw.wei2)
            "伟", "伪","尾" -> mp = MediaPlayer.create(context, R.raw.wei3)
            "卫", "未","位" -> mp = MediaPlayer.create(context, R.raw.wei4)
            ...
            "沃"->mp= MediaPlayer.create(context,R.raw.wo4)
            ...
            //x
            "夕", "西", "吸","希" -> mp = MediaPlayer.create(context, R.raw.xi1)
            "习" -> mp = MediaPlayer.create(context, R.raw.xi2)
            "戏","系" -> mp = MediaPlayer.create(context, R.raw.xi4)
            "下", "吓" -> mp = MediaPlayer.create(context, R.raw.xia4)
            "仙", "先", "纤" -> mp = MediaPlayer.create(context, R.raw.xian1)
            "闲"->mp= MediaPlayer.create(context,R.raw.xian2)
            "县"->mp= MediaPlayer.create(context,R.raw.xian4)
            ...
            "心","辛" -> mp = MediaPlayer.create(context, R.raw.xin1)
            "刑", "行","形" -> mp = MediaPlayer.create(context, R.raw.xing2)
            "兴","杏" -> mp = MediaPlayer.create(context, R.raw.xing4)
            ...
            //y
            "压","呀" -> mp = MediaPlayer.create(context, R.raw.ya1)
            "牙" -> mp = MediaPlayer.create(context, R.raw.ya2)
            "亚" -> mp = MediaPlayer.create(context, R.raw.ya4)
            "延","言" -> mp = MediaPlayer.create(context, R.raw.yan2)
            ...
            "一", "衣","医" -> mp = MediaPlayer.create(context, R.raw.yi1)
            "仪" -> mp = MediaPlayer.create(context, R.raw.yi2)
            "乙", "已", "以" -> mp = MediaPlayer.create(context, R.raw.yi3)
            "亿", "义", "艺", "忆", "议", "亦", "异","役","译" -> mp = MediaPlayer.create(context, R.raw.yi4)
            ...
            "佣"->mp= MediaPlayer.create(context,R.raw.yong1)
            ...
            "尤", "由","邮","犹" -> mp = MediaPlayer.create(context, R.raw.you2)
            "友", "有" -> mp = MediaPlayer.create(context, R.raw.you3)
            "又", "右", "幼" -> mp = MediaPlayer.create(context, R.raw.you4)
            "于","余" -> mp = MediaPlayer.create(context, R.raw.yu2)
            ...
            "丈", "仗","帐" -> mp = MediaPlayer.create(context, R.raw.zhang4)
            ...
            "贞","针" -> mp = MediaPlayer.create(context, R.raw.zhen1)
            "诊"->mp= MediaPlayer.create(context,R.raw.zhen3)
            "阵" -> mp = MediaPlayer.create(context, R.raw.zhen4)
            "争" -> mp = MediaPlayer.create(context, R.raw.zheng1)
            "正","证" -> mp = MediaPlayer.create(context, R.raw.zheng4)
            ...
            "助","住"->mp= MediaPlayer.create(context,R.raw.zhu4)
            ...
            "祖","阻" -> mp = MediaPlayer.create(context, R.raw.zu3)
