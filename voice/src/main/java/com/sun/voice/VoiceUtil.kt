...
object VoiceUtil {
    ...
    private fun createVoice(context: Context, index: Int, voiceString: String): MediaPlayer {
        ...
        when (voiceChar) {
            ...
            "驳", "泊", "脖", "博", "搏" -> mp = MediaPlayer.create(context, R.raw.bo2)
            ...
            "词", "辞", "慈" -> mp = MediaPlayer.create(context, R.raw.ci2)
            ...
            "催" -> mp = MediaPlayer.create(context, R.raw.cui1)
            ...
            "茎", "京", "经", "惊", "晶", "睛" -> mp = MediaPlayer.create(context, R.raw.jing1)
            ...
            "罗", "萝", "锣" -> mp = MediaPlayer.create(context, R.raw.luo2)
            ...
            "木", "目", "牧", "墓", "幕" -> mp = MediaPlayer.create(context, R.raw.mu4)
            //n
            ...
            "塞" -> mp = MediaPlayer.create(context, R.raw.sai4)
            ...
            "蒜" -> mp = MediaPlayer.create(context, R.raw.suan4)
